document.addEventListener("DOMContentLoaded", () => {
    ...
    function renderCompletedTasks() {
        ...
        completedTasks.sort((a, b) => (priorityOrder[a.priority] || 99) - (priorityOrder[b.priority] || 99));
    ...
    function showTaskForm() {
        ...
        >
            ...
            <button
                id="save-task-btn"
                class="bg-primary cursor-pointer rounded-[6px] px-4 py-1.5 text-[12px] text-white md:text-[14px] dark:bg-[#002247]"
            >
                اضافه کردن تسک
            </button>
        ...
        newForm.querySelector("#save-task-btn").addEventListener("click", () => {
            ...
            tasks.push({ title: taskTitle, description: taskDescription, priority: taskPriority });
            ...
            newAddBtn.innerHTML = `
                <div
                    class="add-task-btn cursor-pointer dark:bg-background-navbar-dark text-[14px] md:text-[16px] dark:border-[#203E62]"
                    id="add-task-btn"
                >
            ...
            `;
            const addedBtn = newAddBtn.firstElementChild;
            addTaskButton.remove();
            document.querySelector("main section").insertBefore(addedBtn, taskDetail);
            // addedBtn.addEventListener("click", showTaskForm);
            renderTasks();
        });
    }
